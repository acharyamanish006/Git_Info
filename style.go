...
var helpStyle = lipgloss.NewStyle().Foreground(lipgloss.Color("#FDFF90")).Width(120)
...
// Width(80).
// Rows(data...).
var helpBorder = lipgloss.NewStyle().Border(lipgloss.RoundedBorder()).BorderForeground(lipgloss.Color("#01BE85")).Width(120)
